...
use crate::shared::{
    ...
    definitions::{CellId, BlockId, VarId, IdFactory},
};
...
impl MIRBuilder {
    ...
    fn lower_expr(&mut self, expr: HIRExpression) -> (MIRValue, Vec<MIRStatement>) {
        match expr.expr {
            ...
            HIRExpressionKind::BoolFalse=> (MIRValue{typ: GenericType::Prim(PrimType::Bool) ,value: MIRValueKind::BoolFalse}, Vec::new()),
    ...
    fn lower_field_access(&self, of: MIRValue, field: String, typ: GenericType) -> MIRValue {
